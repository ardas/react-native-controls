...
export default class Select extends PureComponent {
  ...
  _renderSelectControlsWithDivider = () => {
    const { renderDivider } = this.props;
    const controls = this._renderSelectControls();
    return (
      <Fragment>
        {controls}
        {controls && renderDivider()}
      </Fragment>
    );
  };
  ...
  render() {
    ...
    return (
      <Fragment>
          ...
          <View style={[style.container, outerContainerStyles]}>
            <View style={[style.container, innerContainerStyles]}>
              ...
              <ScrollView style={style.container}>
                {this._renderSelectControlsWithDivider()}
                <ItemsContainer
                  data={itemsToShow}
        ...
        <TouchableOpacity onPress={this.toggle} disabled={disabled}>{children}</TouchableOpacity>
      </Fragment>
    );
  }
}
